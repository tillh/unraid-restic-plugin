...
Do not use `v2026.03.31.1`. That release had an invalid `.plg` XML file and Unraid rejected it during installation. Also skip `v2026.03.31.2` and `v2026.03.31.3`, which had page rendering issues on real Unraid systems. Use `v2026.03.31.4` or newer.
